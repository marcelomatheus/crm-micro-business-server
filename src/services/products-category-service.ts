import { categoryProductSchema, createCategoryProductSchema, updateCategoryProductSchema } from "@/zod/products-category-schema";
...
export const updateCategoryProduct = async ({categoryId, payload, userId}:UpdateCategoryProductType) => {
